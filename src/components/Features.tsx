...
const features = [
  {
    ...
    description: "Более 1000 моделей классических и электрических велосипедов от ведущих производителей."
  },
  {
    icon: "Medal",
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-muted-foreground">
            Наш магазин ВелоЭксперт - это команда профессионалов с многолетним опытом работы в велоиндустрии. 
